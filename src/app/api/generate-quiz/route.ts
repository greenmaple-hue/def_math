...
7. **[가장 중요] 난이도별 변별력 확보**: 'difficulty' 필드에 지정된 난이도에 맞추어 문제의 실제 수준을 명확히 구분하세요.
   - 최하/하: 공식만 대입하면 풀리는 매우 단순한 1차원적 개념 확인 문제.
   - 중: 기본적인 개념 2~3가지를 결합하거나 계산 과정이 조금 더 필요한 문제.
   - 상/최상: 실생활 활용, 조건 추론, 또는 여러 단원의 개념이 복합적으로 섞여 있어 심도 깊은 사고력이 요구되는 고난도 문제.
